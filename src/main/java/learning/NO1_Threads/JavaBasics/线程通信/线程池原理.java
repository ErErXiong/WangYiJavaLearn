...
/**
 * @Author by xiongYiMing on 2019/3/18 17:33
 */
public class 线程池原理 {
        /**
        ...
        public static void main(String[] args) throws Exception {
            new 线程池原理().threadPoolExecutorTest1();
//		new 线程池原理().threadPoolExecutorTest2();
//		new 线程池原理().threadPoolExecutorTest3();
//		new 线程池原理().threadPoolExecutorTest4();
//		new 线程池原理().threadPoolExecutorTest5();
//		new 线程池原理().threadPoolExecutorTest6();
//		new 线程池原理().threadPoolExecutorTest7();
//		new 线程池原理().threadPoolExecutorTest8();
        }
